...
def on_connect(client: mqtt.Client, userdata, flags, reason_code, properties):
    ...
    client.subscribe('services/notifier/lp189qb')
    client.subscribe('services/notifier/lp189qb/cmd')
    client.publish('services/notifier/lp189qb/status',json.dumps({"status":"online"}), retain = True)
...
#o.nwZsV0h78w2CD51a6JE1EwNHRJ8QYAVL
...
def main():
    ...
    client.will_set('services/notifier/lp189qb/status', json.dumps({"status":"offline"}), retain=True)
